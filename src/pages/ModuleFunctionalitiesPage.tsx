      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
        {functionalities.map((item) => (
          <Link
            key={item.path}
            to={item.path}
            className="group block cursor-pointer rounded-2xl bg-white p-5 shadow-sm transition hover:bg-slate-50 hover:shadow-md focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:outline-none active:bg-slate-100 sm:p-6 sm:hover:-translate-y-1"
          >
