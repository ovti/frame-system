    ...
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-slate-50 px-4 py-6 sm:px-6 sm:py-8">
      ...
      <section className="relative z-10 flex min-h-105 w-full max-w-5xl items-center justify-center overflow-hidden rounded-3xl bg-white/90 px-5 py-14 text-center shadow-sm backdrop-blur-sm sm:min-h-110 sm:px-8 sm:py-16 md:min-h-120 md:px-12 md:py-20">
        ...
        <div className="relative z-10 w-full">
          <h1 className="text-4xl font-bold tracking-tight wrap-break-word text-slate-950 sm:text-5xl md:text-7xl">
            GRAGRAFRAME
          </h1>

          <p className="mx-auto mt-5 max-w-2xl text-base leading-7 font-medium text-slate-600 sm:mt-6 sm:text-xl sm:leading-8 md:text-2xl">
            GRAPH GRAMMAR-BASED
          </p>

          <p className="mx-auto mt-1 max-w-2xl text-base leading-7 font-medium text-slate-600 sm:mt-2 sm:text-xl sm:leading-8 md:text-2xl">
